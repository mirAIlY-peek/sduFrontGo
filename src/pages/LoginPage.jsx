    ...
    <div className ="flex w-full h-full lg:ml-24 px-10 py-10 justify-between place-items-center mt-20">
      <div className= "bg-white w-full sm:w-full md:w-1/2 lg:w-1/3 px-7 py-7 rounded-xl justify-center align-middle">
        ...
        <form className="flex flex-col w-auto items-center" onSubmit={loginUser}>
            <h1 className='px-3 font-extrabold mb-5 text-black text-2xl '>Sign In</h1>
            ...
            <div className="w-full py-4">
              <button
                  type="submit"
                  className="w-full bg-black hover:bg-beige text-white font-bold py-2 px-4 rounded-xl shadow-md transition duration-300"
              > Sign in </button>
            </div>
            ...
            <div className="container2 ">
              <div className="w-full h-full p-1">
                <Link to={'/login'}>
                  <button
                      type="submit"
                      className="w-full bg-black hover:bg-beige text-white font-bold py-2 px-4 rounded-xl shadow-md transition duration-300"> Sign In</button>
                </Link>
              </div>
              <div className="w-full h-full p-1">
                <Link to={'/register'}>
          ...
          <Link to={'/'}>
            <button className="w-full bg-gray-200 hover:bg-gray-300 text-black font-bold py-2 px-4 rounded-xl shadow-md transition duration-300 flex items-center justify-center">
